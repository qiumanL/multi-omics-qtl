...
parallel -j 6 /zs32/data-analysis/liucy_group/liangqiuman/software/qtltools/bin/QTLtools cis --vcf ../genotype/genotypes.all.chr{}.realign.vcf.gz --bed ../expression/log2cpm.fgene.fsample.qn.realign.lmPEER29.norm.sub.chr{}.bed.gz --std-err --out rqtl.nominal.chr{} --nominal 0.05 \> log/log.nominal.all.chr{}  ::: {1..22}
## Permutation pass
