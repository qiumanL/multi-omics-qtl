python3 /zs32/data-analysis/liucy_group/liangqiuman/software/MetaXcan/MetaXcan-0.6.11/software/MetaXcan.py --model_db_path /vg_sklmgdata_hw_01/data/liangqiuman/psychencode/another_analysis/code/2.omics-specific-genes/origin_model/ribo/output/braingvex.db --covariance /vg_sklmgdata_hw_01/data/liangqiuman/psychencode/another_analysis/code/2.omics-specific-genes/origin_model/ribo/output/braingvex.cov --gwas_file /vg_sklmgdata_hw_01/data/liangqiuman/database/PGC3/2021_PGC3_SCZ.gz --snp_column SNP --effect_allele_column A1 --non_effect_allele_column A2 --or_column OR --pvalue_column P --output_file 2021PGC3.asso.csv
