Rscript conditional.lm.R ribo
sed -i 's/^\t/geneid\t/g' sub.expr.resid

ln -s /vg_sklmgdata_hw_01/data/liangqiuman/psychencode/another_analysis/code/2.omics-specific-genes/origin_model/ribo/data/genotypes.sub.addCM.* .
