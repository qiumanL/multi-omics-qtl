#import sys
#sys.path.append("/zs32/home/yjiang/softwares/MetaXcan-master/software")

#import metax
#sys.path.append("/zs32/home/yjiang/softwares/MetaXcan-master/software/metax")
import sys
sys.path.append("/zs32/data-analysis/liucy_group/liangqiuman/software/MetaXcan/MetaXcan-0.6.11/software/")

import metax
### new add
sys.path.append("/zs32/data-analysis/liucy_group/liangqiuman/software/MetaXcan/MetaXcan-0.6.11/software/metax")
