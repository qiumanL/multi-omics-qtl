## chr=22 gene=ENSG00000159873 name=CCDC117
chr=$1
gene=$2
name=$3
mkdir $gene
...
### coloc snp
top_coloc_snp=`awk -F "\t" 'NR>1{print $1}' <(head -2 /vg_sklmgdata_hw_01/data/liangqiuman/psychencode/another_analysis/6.coloc/eqtl/chr"$chr"/"$gene"/coloc_snp_PP4.txt)`
