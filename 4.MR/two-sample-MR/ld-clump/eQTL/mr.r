...
#### LD_clumped snplist
eqtl_snplist<-read.table(paste0('/vg_sklmgdata_hw_01/data/liangqiuman/psychencode/another_analysis/code/4.MR/prepare_files/plink_ld-clump/eQTL/chr',opt$chr,'/',opt$gene,'/proxy_snp.snpid'))[,2]
#snplist
###### read our own data
