...
#### LD_clumped snplist
rqtl_snplist<-read.table('/vg_sklmgdata_hw_01/data/liangqiuman/psychencode/another_analysis/code/4.MR/prepare_files/susie_fine-mapping/rQTL/chr'.opt$chr,'/'.opt$gene,'/cs.snp.txt')[,1]
rqtl_snplist
###### read our own data
