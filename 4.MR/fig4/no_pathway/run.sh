## chr=2 gene=ENSG00000115524 name=SF3B1
chr=$1
gene=$2
name=$3
mkdir $gene
...
############## for boxplot
top_eqtl_snp=`awk '$1=="'$gene'"{print $8}' /vg_sklmgdata_hw_01/data/liangqiuman/psychencode/another_analysis/1.qtl/shared/eqtl/eqtl.permute.qvalue.txt`
