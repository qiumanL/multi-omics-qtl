...
rqtl.susie<-paste0('X',as.character(read.table(paste0('/vg_sklmgdata_hw_01/data/liangqiuman/psychencode/another_analysis/code/4.MR/prepare_files/susie_fine-mapping/rQTL/chr',chr,'/',gene,'/cs.snp.txt'))[,1]))
snplist<-rqtl.susie
...
pqtl<-read.table(paste0('/vg_sklmgdata_hw_01/data/liangqiuman/psychencode/another_analysis/code/4.MR/prepare_files/susie_fine-mapping/pQTL/chr',chr,'/',gene,'/',gene,'.',protein,'.exp'),sep="\t")
